  ...
  return (
    <div className='w-full h-[82vh] bg-[#0c0e17] rounded-lg'>
      <nav className='h-15 px-4 py-2 flex items-center justify-between'>
        ...
        <button
          className="flex justify-center items-center bg-gradient-to-r from-[#000cff] to-[#3636e6] border border-blue-600 py-0.5 rounded-md gap-1.5 px-2 "
        >
      ...
      <div className='w-full px-4'>
        <CodeEditor code={currentCode.content} selectedLanguage={currentCode.language} />
      </div>
    </div>
  )
}
